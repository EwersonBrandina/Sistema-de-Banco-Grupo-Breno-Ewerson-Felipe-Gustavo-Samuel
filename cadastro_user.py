...
fr2_1 = LabelFrame(root, text="Banco Dellux", bg="green").grid(row=0, column=0)
...
# Botões
bt0_fr2 = Button(fr2_1, text="Criar conta ", font=("Mongolian Baiti", "11", "bold"), height=2,width=15, bg="#eb8334", fg="#fff").grid(row=6, column=0, sticky=EW, pady= 30)

bt1_fr2 = Button(fr2_1, text="Voltar", font=("Mongolian Baiti", "11", "bold"), height=2,width=15, bg="#eb8334", fg="#fff").grid(row=6, column=1, sticky=EW)
