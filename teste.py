...
def mostrar(*args):
    #ss = Entry(root,textvariable = senha).grid
    ...
    feecho = Button(fr1, text='👁', font=('Mongolian Baiti', "13", "bold"),bg='#eb8334', fg='#fff',command=esconde).grid(row=2, column=1, padx=617)
    #  E wuanod isso acontece tambem substituimos o botão de mostrar por um de esconder  q chama a função a baixo

def esconde(*args):
    #ss = Entry(root,textvariable = senha, show="*").grid
