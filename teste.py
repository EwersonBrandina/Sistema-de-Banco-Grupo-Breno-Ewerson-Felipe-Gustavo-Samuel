...
in0_fr2 = Entry(fr2_1, font=('Arial 17'), textvariable=var,width=47, bg="#f5f5f5")
...
in1_fr2 = Entry(fr2_1, font=('Arial 17'),width=19, bg='#f5f5f5')
...
in2_fr2 = Entry(fr2_1, font=('Arial 17'),width=20, bg='#f5f5f5', cursor="gobbler")
in2_fr2.bind('<KeyRelease>', data_nasc)
in2_fr2.grid(row=2, column=0, sticky=W,padx=473)
#Linha 3
lb4_fr2 = Label(fr2_1, text="Tel:", font=("Mongolian Baiti", "17"),background="#8a37cc", fg="#f5f5f5" ).grid(row=3, column=0, sticky=W,padx=82)
in3_fr2 = Entry(fr2_1, font=('Arial 17'),width=19, bg='#f5f5f5')
...
lb4_fr2 = Entry(fr2_1, font=('Arial 17'),width=19, bg='#f5f5f5',textvariable=var4)
...
in10_fr2 = Entry(fr2_1, font=('Arial 17'), bg='#f5f5f5')
in10_fr2.grid(row=6, column=0, sticky=W,padx=473)
# Botões
...
in2_fr3_1 = Entry(fr3_1,  text='', font= ('Arial 16'),width=50, bg='#f5f5f5',textvariable=var)
...
in6_fr3_1 = Entry(fr3_1, text='', font= ('Arial 16'),width=22, bg='#f5f5f5')
in6_fr3_1.grid(row=3, column=0, sticky=W,padx=132) #LOGRADOURO
in7_fr3_1 = Entry(fr3_1, text='', font= ('Arial 16'),width=22,bg='#f5f5f5', textvariable=var5)
in7_fr3_1.grid(row=4, column=0, sticky=W,padx=132) #CIDADE
in8_fr3_1 = Entry(fr3_1, text='', font= ('Arial 16'), bg='#f5f5f5',textvariable=var6)
