...
#botões
bt0_fr3 = Button(fr3, text='Login', font = ('Mongolian Baiti', '20', 'bold' ) , bg='#eb8334', fg='#f5f5f5',width=13, command= lambda:[login(), in0_fr3.delete(0, 'end'), in1_fr3.delete(0, 'end'), fr3.grid_remove(), fr4.grid(row=0, column=0)]).grid(row=4, column=0, sticky=W,padx=30,pady=10)
...
lb0_fr4 = Label(fr4, text='Usuário', font='Arial 20',padx=5, pady=0, bg='#8a37cc',fg='#f5f5f5').grid(row=0, column=0 , sticky=W)
...
bt2_fr4_3 = Button(fr4_3, text='Confirmar', font=('Mongolian Baiti', '19', 'bold' ),padx=5, pady=0, bg= '#eb8334',fg='#f5f5f5',width=19, command= lambda: transfere_calculo()).grid(row=2, column=0, sticky=W, padx=282,pady=5)
