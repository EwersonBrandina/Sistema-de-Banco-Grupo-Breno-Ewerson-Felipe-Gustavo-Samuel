...
def transfere_calculo():
    for i in range (len(V_Conta)):
            if V_Conta[i].num == in1_1_fr4_3.get():
                ...
                V_Conta[i].recebe_transferencia(float(in0_fr4_3.get()),V_Conta[login_aprovado])
                V_Conta[login_aprovado].extrato()
                V_Conta[i].extrato()
...
def mostrar(*args):
    ...
    feecho = Button(fr1, text='👁', font=('Mongolian Baiti', "14", "bold"),bg='#eb8334', fg='#fff', command=esconder).grid(row=2, column=1, padx=617)
def esconder(*args):
    in1_fr1 = Entry(fr1, textvariable=hello, font='Arial 18', width=35, show="*").grid(row=2,column=1,sticky=W,padx=154)
    bt2_fr1 = Button(fr1, text='👁', font=('Mongolian Baiti', "14", "bold"),bg='#eb8334', fg='#fff', command=mostrar).grid(row=2, column=1, padx=617)

hello_1=StringVar()
def mostrar_1(*args):
    in1_fr3 = Entry(fr3, textvariable=hello_1, font='Arial 20', bg='#fff').grid(row=3, column=0,sticky=W,padx=240,pady=10)
    feecho = Button(fr3, text='👁', font=('Mongolian Baiti', "14", "bold"),bg='#eb8334', fg='#fff',command=esconder_1).grid(row=3, column=0, sticky=W,padx=550,pady=5)
def esconder_1(*args):
    in1_fr3 = Entry(fr3, textvariable=hello_1, font='Arial 20', bg='#fff',show="*").grid(row=3, column=0,sticky=W,padx=240,pady=10)
    bt7_fr3 = Button(fr3, text='👁', font=('Mongolian Baiti', "14", "bold"),bg='#eb8334', fg='#fff',command=mostrar_1).grid(row=3, column=0, sticky=W,padx=550,pady=5)
def mensagem():
...
lb1_fr1 = Label(fr1, text='CPF:', font=('Mongolian Baiti', '22'),bg='#8a37cc',fg='#f5f5f5').grid(row=1, column=1,sticky=W, padx=92)
lb2_fr1 = Label(fr1, text='Senha:', font=('Mongolian Baiti', "22" ),bg='#8a37cc',fg='#f5f5f5',width=7).grid(row=2, column=1,sticky=W, padx=55)
#--Entrada ---
...
#Botões
bt0_fr2 = Button(fr2, text="Sair", font=("Mongolian Baiti", "18", "bold"), height=2,width=20, bg="#eb8334", fg="#fff", command= lambda: [fr2.grid_remove(), fr1.grid(row=0, column=0)] ).grid(row=6, column=0,sticky=W,padx=400,pady=20)
...
bt0_fr2 = Button(fr2, text="Acessar", font=("Mongolian Baiti", "18", "bold"), height=2,width=20, bg="#eb8334", fg="#fff", command= lambda: [fr2.grid_remove(), fr3.grid(row=0, column=0)] ).grid(row=6, column=0,sticky=W,padx=100)
...
# Botões
bt0_fr2 = Button(fr2_2, text="Deletar conta ", font=("Mongolian Baiti", "19", "bold"),width=18, bg="#eb8334", fg="#fff", command= lambda:[apagar_conta(), in0_fr2.delete(0,'end'),in0_fr2_1.delete(0,'end'),in1_fr2.delete(0,'end'), in1_fr2_1.delete(0,'end'), fr2_2.grid_remove(), fr2.grid(row=0,column=0)]).grid(row=4, column=0, sticky=W, padx=40,pady=30) #Pura Gambiarra e ta tudo bem
...
bt4_fr4_1 = Button(fr4_1, text='Voltar', font=('Mongolian Baiti', '19', 'bold' ),padx=5, pady=0, bg='#eb8334',fg='#f5f5f5',width=15, command= lambda: [mensagem(),in0_fr4_1.delete(0, 'end'), in1_fr4_1.delete(0, 'end'), fr4_1.grid_remove(), fr4.grid(row=0, column=0, sticky=NSEW)]).grid(row=4, column=0, sticky=W,padx=190,pady=5)
bt4_1_fr4_1 = Button(fr4_1, text='Sair', font=('Mongolian Baiti', '19', 'bold' ),padx=5, pady=0, bg= '#eb8334',fg='#f5f5f5',width=15, command= lambda:[mensagem(),in1_fr4_1.delete(0, 'end'), fr4_1.grid_remove(), fr3.grid(row=0, column=0)]).grid(row=4, column=0, sticky=W,padx=450)
...
bt4_fr4_2 = Button(fr4_2, text='Voltar', font=('Mongolian Baiti', '19', 'bold' ),padx=5, pady=0, bg='#eb8334',fg='#f5f5f5',width=15, command= lambda: [mensagem(),in0_fr4_2.delete(0, 'end'), in1_fr4_2.delete(0, 'end'), fr4_2.grid_remove(),fr4.grid(row=0, column=0, sticky=NSEW)]).grid(row=4, column=0, sticky=W,padx=190,pady=5)
bt4_1_fr4_2 = Button(fr4_2, text='Sair', font=('Mongolian Baiti', '19', 'bold' ),padx=5, pady=0, bg='#eb8334',fg='#f5f5f5',width=15, command= lambda: [mensagem(),in0_fr4_2.delete(0, 'end'), in1_fr4_2.delete(0, 'end'), fr4_2.grid_remove(), fr3.grid(row=0, column=0)]).grid(row=4, column=0, sticky=W,padx=450)
...
bt4_fr4_3 = Button(fr4_3, text='Voltar', font=('Mongolian Baiti', '19', 'bold' ),padx=5, pady=0,  bg= '#eb8334',fg='#f5f5f5',width=15, command= lambda: [mensagem(),in1_1_fr4_3.delete(0,'end'), in0_fr4_3.delete(0, 'end'), in1_fr4_3.delete(0, 'end'), fr4_3.grid_remove(), fr4.grid(row=0, column=0, sticky=NSEW)]).grid(row=5, column=0, sticky=W,padx=190,pady=5)
bt4_1_fr4_3 = Button(fr4_3, text='Sair', font=('Mongolian Baiti', '19', 'bold' ),padx=5, pady=0, bg= '#eb8334',fg='#f5f5f5',width=15, command= lambda:[mensagem(),in1_1_fr4_3.delete(0,'end'), in0_fr4_3.delete(0, 'end'), in1_fr4_3.delete(0, 'end'), fr4_3.grid_remove(), fr3.grid(row=0, column=0)]).grid(row=5, column=0, sticky=W,padx=450)
...
bt4_fr4_4 = Button(fr4_4, text='Voltar', font=('Mongolian Baiti', '19', 'bold' ),padx=5, pady=0,  bg= '#eb8334',fg='#f5f5f5',width=15, command= lambda: [mensagem(), in0_fr4_4.delete(0, 'end'), in1_fr4_4.delete(0, 'end'), fr4_4.grid_remove(),fr4.grid(row=0, column=0, sticky=NSEW)]).grid(row=4, column=0, sticky=W,padx=190,pady=5)
bt4_1_fr4_4 = Button(fr4_4, text='Sair', font=('Mongolian Baiti', '19', 'bold' ),padx=5, pady=0, bg= '#eb8334',fg='#f5f5f5',width=15, command= lambda: [mensagem(), in0_fr4_4.delete(0, 'end'), in1_fr4_4.delete(0, 'end'), fr4_4.grid_remove(), fr3.grid(row=0, column=0)]).grid(row=4, column=0, sticky=W,padx=450)
